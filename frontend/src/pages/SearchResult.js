...
const SearchResult = props => {
    ...
    const [ranked4sEnemyPortalsEntered, setRanked4sEnemyPortalsEntered]=useState([]);
    const [ranked4sEnemyPortalsDestroyed, setRanked4sEnemyPortalsDestroyed]=useState([]);
    ...
    useEffect(() => {
        const getStats = async () => {
            await fetch(`http://localhost:3001/search/${searchPlatform}/${searchGamertag}`)
            ...
            .then(result=>{
                const setAll = () => {
                    ...
                    setAllyPortalsEntered(overall.stats.allyPortalsEntered.displayValue)
                    setEnemyPortalsEntered(overall.stats.enemyPortalsEntered.displayValue)
                    setEnemyPortalsDestroyed(overall.stats.enemyPortalsDestroyed.displayValue)

                    setDamageDealt(overall.stats.damageDealt.displayValue);
                    setShotsLanded(overall.stats.shotsLanded.displayValue)
                    setShotsMissed((overall.stats.shotsFired.value - overall.stats.shotsLanded.value))
                    ...
                    setRanked4sKillsThruPortal(ranked4v4.stats.killsThruPortal.displayValue);
                    setRanked4sPortalsSpawned(ranked4v4.stats.portalsSpawned.displayValue)
                    setRanked4sDistancePortaled(ranked4v4.stats.distancePortaled.displayValue)
                    setRanked4sOwnPortalsEntered(ranked4v4.stats.ownPortalsEntered.displayValue)
                    setRanked4sAllyPortalsEntered(ranked4v4.stats.allyPortalsEntered.displayValue)
                    setRanked4sEnemyPortalsEntered(ranked4v4.stats.enemyPortalsEntered.displayValue)
                    setRanked4sEnemyPortalsDestroyed(ranked4v4.stats.enemyPortalsDestroyed.displayValue)
                    ...
                    setRanked4sShotsMissed((ranked4v4.stats.shotsFired.value - ranked4v4.stats.shotsLanded.value))
    ...
    return (
        ...
        <div className="absolute w-screen flex justify-end mt-16 -ml-20 mb-10 text-white text-xl font-medium">
           <img className="mr-1 -mt-1" src={profilePic} alt="" width="35" height="35"/> {`${gt}`}
        </div>
              ...
              <section className="w-2/3 mt-8">
                ...
                <ul className="flex flex-wrap">
                    ...
                    <li>
                        ...
                        <span className="ml-16">Kills Thru Portal &nbsp; {killsThruPortal}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Portals Spawned &nbsp; {portalsSpawned}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Distance Portaled &nbsp; {distancePortaled}m</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Your Portals Entered &nbsp; {ownPortalsEntered}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Teammate Portals Entered &nbsp; {allyPortalsEntered}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Enemy Portals Entered &nbsp; {enemyPortalsEntered}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Enemy Portals Destroyed &nbsp; {enemyPortalsDestroyed}</span>
                    </li>
                </ul>
              </section>
              ...
              <section className="w-4/5 mt-8">
                ...
                <ul className="flex flex-wrap">
                    ...
                    <li className="ml-8">
                        ...
                        <span className="ml-8">Games Played &nbsp; {gamesPlayed}</span>
                    </li>
                    <li className="ml-8">
            ...
            <section className="w-3/5">
              ...
              <section className="w-2/3 mt-8">
                ...
                <ul className="flex flex-wrap">
                    <li>
                    <GiHealthDecrease className="damage -mb-5"/>
                    <span className="ml-8">Portal Kills &nbsp; {ranked4sPortalKills}</span>
                    </li>
                    <li>
                        <GiInternalInjury className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Kills Thru Portal &nbsp; {ranked4sKillsThruPortal}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Portals Spawned &nbsp; {ranked4sPortalsSpawned}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Distance Portaled &nbsp; {ranked4sDistancePortaled}m</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Your Portals Entered &nbsp; {ranked4sOwnPortalsEntered}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Teammate Portals Entered &nbsp; {ranked4sAllyPortalsEntered}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Enemy Portals Entered &nbsp; {ranked4sEnemyPortalsEntered}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Enemy Portals Destroyed &nbsp; {ranked4sEnemyPortalsDestroyed}</span>
                    </li>
                </ul>
              </section>
              ...
              <section className="w-2/3 mt-8">
                ...
                <ul className="flex flex-wrap">
                    <li>
                    <GiBullseye className="gunfight -mb-5"/>
                    <span className="ml-8">Shots Landed &nbsp; {ranked4sShotsLanded}</span>
                    </li>
                    <li>
                    <MdClose className="gunfight -mb-5 ml-8 relative top-0.5"/>
                        <span className="ml-16">Shots Missed &nbsp; {ranked4sShotsMissed}</span>
                    </li>
                    <li>
                        <FaPercentage className="damage -mb-5 ml-8"/>
                        <span className="ml-16">Accuracy &nbsp; {ranked4sAccuracy}</span>
                    </li>
                    <li>
                    <GiHealthDecrease className="damage -mb-5"/>
                    <span className="ml-8">Damage Dealt &nbsp; {ranked4sDamageDealt}</span>
                    </li>
                </ul>
              </section>

              <section className="w-3/5 mt-8">
                <h5 className="text-xl font-medium">Ranked 4v4 Gunfight Breakdown</h5>
                <ul className="flex flex-wrap">
                    <li>
                        <GiTargeted className="gunfight kdratio -mb-5"/>
                        <span className="ml-8">Headshots &nbsp; {ranked4sHeadshots}</span>
                    </li>
                    <li className="ml-8">
                    <GiMailedFist className="gunfight -mb-5"/>
                    ...
                    <li className="ml-8">
                        <GiMissileSwarm className="gunfight -mb-5"/>
                        <span className="ml-8">Collaterals &nbsp; {ranked4sCollaterals}</span>
                    </li>
                    <li className="ml-8">
                        <GiBattleTank className="gunfight -mb-5"/>
              ...
              <section className="w-4/5 mt-8">
                ...
                <ul className="flex flex-wrap">
                    ...
                    <li>
                        <GiStopwatch className="gunfight -mb-5 ml-8"/>
                        <span className="ml-16">Time Played &nbsp; {ranked4sTimePlayed}</span>
                    </li>

                    <div className="mt-8 flex">
                    <li className="ml-8">
                        <ImSigma className="gunfight -mb-5"/>
                        <span className="ml-8">Games Played &nbsp; {ranked4sGamesPlayed}</span>
                    </li>
                    <li className="ml-8">
                        <FaPercentage className="gunfight -mb-5"/>
                        <span className="ml-8">Win Rate &nbsp; {ranked4sWlPercentage}</span>
                    </li>
                    <li className="ml-8">
